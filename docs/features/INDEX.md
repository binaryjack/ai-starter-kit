...
- [Multi-Tenant Isolation](./11-multi-tenant.md) — Per-tenant run and data isolation with GDPR export/erasure
- [PII Scrubbing & Security](./12-pii-security.md) — Automatic credential redaction and prompt sanitization
...
| Agent Types & Roles | [02](./02-agent-types-roles.md) | ✅ Documented | P0 | Core |
| Model Routing & Cost | [03](./03-model-routing-cost.md) | ✅ Documented | P0 | Core |
| Check Handlers | [04](./04-check-handlers.md) | ✅ Documented | P0 | Core |
...
| Multi-Tenant Isolation | [11](./11-multi-tenant.md) | ✅ Documented | P1 | G-27 |
| PII & Security | [12](./12-pii-security.md) | ✅ Documented | P1 | G-30/31 |
| DAG Builder API | [13](./13-dag-builder-api.md) | ✅ Documented | P0 | G-22 |
| Plugin System | [14](./14-plugin-system.md) | ✅ Documented | P2 | G-18 |
| CLI Commands | [15](./15-cli-commands.md) | ✅ Documented | P0 | Core |
| MCP Integration | [16](./16-mcp-integration.md) | ✅ Documented | P0 | Core |
| OpenTelemetry | [17](./17-opentelemetry.md) | ✅ Documented | P1 | G-08 |
| Real-time Dashboard | [18](./18-dashboard.md) | ✅ Documented | P1 | G-26 |
| Cost Analytics | [19](./19-cost-analytics.md) | ✅ Documented | P1 | Core |
| Vector Memory | [20](./20-vector-memory.md) | ✅ Documented | P1 | G-24/25 |
| Event-Driven Triggers | [21](./21-event-triggers.md) | ✅ Documented | P2 | G-16 |
| WebSocket/SSE API | [22](./22-websocket-sse.md) | ✅ Documented | P1 | G-28 |
| Provider Config | [23](./23-provider-config.md) | ✅ Documented | P2 | Core |
| Notifications | [24](./24-notifications.md) | ✅ Documented | P2 | G-43 |
...
- [Multi-tenant isolation](./11-multi-tenant.md) (G-27) ✅
- [PII scrubbing](./12-pii-security.md) (G-30/31) ✅
...
**Last Updated**: March 7, 2026 — All 27 feature guides documented  
**Version**: 1.0.0+  
